altairApp
    .config([
        ...
        '$urlRouterProvider',
        'variables',
        function ($stateProvider, $urlRouterProvider, variables) {
            ...
            // -- DASHBOARD --
                .state("restricted.dashboard", {
                    url: "/",
                    templateUrl: 'app/components/dashboard/erpView.html',
                    controller: 'erpCtrl',
                    resolve: {
                        deps: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                ...
                                'lazy_google_maps',
                                'lazy_clndr',
                                'app/components/dashboard/erpController.js'
                            ], {serie: true} );
                        }],
            ...
            // -- E-COMMERCE --
                ...
                .state("restricted.ecommerce.comment_edit", {
                    url: "/comment_edit/{commentId}",
                    templateUrl: 'app/components/ecommerce/comment_editView.html',
                    controller: 'commentCtrl',
                    resolve: {
                        deps: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                'app/components/ecommerce/commentController.js'
                            ]);
                        }]
                    },
                    data: {
                ...
                .state("restricted.ecommerce.products_list", {
                    url: "/products_list",
                    templateUrl: 'app/components/ecommerce/comment_listView.html',
                    ...
                    resolve: {
                        ...
                        deps: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                'lazy_pagination',
                                'app/components/ecommerce/comment_listController.js'
                            ], { serie: true } );
                        }]
                    },
                    data: {
            ...
            // -- PLUGINS --
                ...
                .state("restricted.plugins.calendar", {
                    url: "/calendar",
                    templateUrl: 'app/components/plugins/eventScheduleView.html',
                    controller: 'eventScheduleCtrl',
                    resolve: {
                        deps: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                'lazy_fullcalendar',
                                'app/components/plugins/eventScheduleController.js'
                            ]);
                        }]
                    },
                    data: {
                ...
                .state("restricted.plugins.charts", {
                    url: "/charts",
                    templateUrl: 'app/components/plugins/photoStatisticView.html',
                    controller: 'photoStatisticCtrl',
                    resolve: {
                        deps: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                'lazy_charts_chartist',
                                'lazy_charts_metricsgraphics',
                                'lazy_charts_c3',
                                'app/components/plugins/photoStatisticController.js'
                            ], {serie: true});
                        }],
                ...
                .state("restricted.plugins.awardRight", {
                    url: "/awardRight",
                    templateUrl: 'app/components/plugins/awardRightView.html',
                    controller: 'awardRightCtrl',
                    resolve: {
                        deps: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                'lazy_tablesorter',
                                'app/components/plugins/awardRightController.js'
                            ],{serie:true});
                        }],
                        ts_data: function($http){
                            return $http({ method: 'GET', url: 'data/tablesorter.json' })
                    ...
                    data: {
                        pageTitle: 'AwardRight'
                    }
                })

                .state("restricted.plugins.userList", {
                    url: "/userList",
                    templateUrl: 'app/components/plugins/userListView.html',
                    controller: 'userListCtrl',
                    resolve: {
                        deps: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                'lazy_tablesorter',
                                'app/components/plugins/userListController.js'
                            ],{serie:true});
                        }],
                        ts_data: function($http){
                            return $http({ method: 'GET', url: 'data/tablesorter.json' })
            ...
            // -- PAGES --
                ...
                .state("restricted.pages.invoices", {
                    url: "/invoices",
                    abstract: true,
                    templateUrl: 'app/components/pages/album_listView.html',
                    controller: 'albumCtrl',
                    resolve: {
                        deps: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load('app/components/pages/albumController.js');
                        }],
                ...
                .state("restricted.pages.invoices.list", {
                    ...
                    views: {
                        'ivoice_content': {
                            templateUrl: 'app/components/pages/album_blankView.html',
                            controller: 'albumCtrl'
                        }
                    },
                    data: {
                ...
                .state("restricted.pages.invoices.details", {
                    ...
                    views: {
                        'ivoice_content': {
                            templateUrl: 'app/components/pages/album_detailView.html',
                            controller: 'albumCtrl'
                        }
                    },
                ...
                .state("restricted.pages.invoices.add", {
                    ...
                    views: {
                        'ivoice_content': {
                            templateUrl: 'app/components/pages/album_addView.html',
                            controller: 'albumCtrl'
                        }
                    },
                    params: { hidePreloader: true }
                ...
                .state("restricted.pages.mailbox", {
                    url: "/mailbox",
                    templateUrl: 'app/components/pages/eventView.html',
                    controller: 'eventCtrl',
                    resolve: {
                        deps: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load('app/components/pages/eventController.js');
                        }],
                        events: function($http,$window){
                            // return $http({ method: 'GET', url: 'data/mailbox_data.json' })
                            //     .then(function (data) {
                            //         return data.data;
                            //     });
                                        return $http
                                            .get(variables.url + 'api/v1/eventsByPhotographer/' + $window.sessionStorage.getItem('id'))
                                            //.get(variables.url + 'api/v1/events')
                                            .then(
                                                function success(data) { 
                                                    ...
                                                    if(data.data['success'] == true){
                                                        ...
                                                        UIkit.modal.alert(data.data['result']);
                                                        return false;
                                                    }
                                                },
                                                function error(data,status){ 
                                                    UIkit.modal.alert( "failure message: " + JSON.stringify({data: data.data}));
                                                    return false;
                                                }
                                            );
                            // var res = $http.get(variables.url + 'api/v1/events/null');
                            ...
                            //     UIkit.modal.alert( "failure message: " + JSON.stringify({data: data}));
                            // }); 
                ...
                .state("restricted.pages.scrum_board", {
                    url: "/scrum_board",
                    templateUrl: 'app/components/pages/event_scheduleView.html',
                    controller: 'event_scheduleCtrl',
                    resolve: {
                        deps: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                'lazy_dragula',
                                'app/components/pages/event_scheduleController.js'
                            ],{serie: true});
                        }],
