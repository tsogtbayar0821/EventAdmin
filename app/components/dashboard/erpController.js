angular
    ...
    .controller('erpCtrl', [
        ...
        '$window',
        '$state',
        function ($rootScope,$scope,$interval,$timeout,sale_chart_data,user_data,variables,$window,$state) {
        ...
        // Visitors chart
            $scope.visitors_chart_data = [sale_chart_data];

            for (var i = 0; i < $scope.visitors_chart_data.length; i++) {
                $scope.visitors_chart_data[i] = MG.convert.date($scope.visitors_chart_data[i], 'date');
            }
            $scope.visitors_chart_options = {
                data: $scope.visitors_chart_data,
                y_scale_type: 'log',
                right: 20,
                x_accessor: 'date',
                y_accessor: 'value',
